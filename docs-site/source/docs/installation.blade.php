...
<div class="prose prose-lg max-w-none">
    ...
    <section class="bg-white border border-gray-200 rounded-lg p-6 mb-8">
        <h2 class="mt-0">Install via Composer</h2>
    ...
    <section class="bg-white border border-gray-200 rounded-lg p-6 mb-8">
        <h2 class="mt-0">Publish Configuration</h2>
        ...
        <p class="mb-0">This will publish the configuration file to <code class="bg-gray-100 px-2 py-1 rounded">config/ussd.php</code>.</p>
    </section>

    <section class="bg-white border border-gray-200 rounded-lg p-6 mb-8">
        <h2 class="mt-0">Configuration File</h2>
    ...
    <section class="bg-white border border-gray-200 rounded-lg p-6 mb-8">
        <h2 class="mt-0">Understanding the Configuration</h2>
        <div class="space-y-4">
    ...
    <section class="bg-white border border-gray-200 rounded-lg p-6 mb-8">
        <h2 class="mt-0">Create Your First State</h2>
