...
<div class="prose prose-lg max-w-none">
    ...
    <section class="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl p-8 mb-8 shadow-lg shadow-slate-200/50 hover:shadow-xl hover:shadow-slate-300/50 transition-all duration-300">
        ...
        <p class="text-slate-700 mb-4">Laravel USSD has the following requirements:</p>
        <ul class="space-y-3 text-slate-700 mb-0">
            <li class="flex items-start">
                ...
                <strong class="text-slate-900">PHP:</strong> ^8.1
            </li>
            <li class="flex items-start">
                <svg class="w-5 h-5 text-primary-600 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <strong class="text-slate-900">Laravel:</strong> ^8.0|^9.0|^10.0|^11.0|^12.0
            </li>
            <li class="flex items-start">
                <svg class="w-5 h-5 text-primary-600 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <strong class="text-slate-900">Cache Driver:</strong> Any Laravel-supported cache driver (Redis, Memcached, Database, File, Array)
            </li>
        </ul>
    </section>
    ...
    <section class="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl p-8 mb-8 shadow-lg shadow-slate-200/50 hover:shadow-xl hover:shadow-slate-300/50 transition-all duration-300">
        ...
        <ul class="space-y-3 text-slate-700 mb-0">
            <li class="flex items-start">
                ...
                <strong class="text-slate-900">Redis</strong> or <strong class="text-slate-900">Memcached</strong> for production environments (better performance for session management)
            </li>
            <li class="flex items-start">
                <svg class="w-5 h-5 text-primary-600 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <strong class="text-slate-900">PHP 8.2+</strong> for better performance
            </li>
        </ul>
    </section>
</div>
